...
class SensorManager:
    ...
    def save_rgb_image(self, image):
        ...
        print("rgb camera shape: {}".format(array.shape))
        array = array[:, :, :3]
        array = array[:, :, ::-1]
    ...
    def save_lidar_image(self, image):
        ...
        print("lidar points: {}".format(points.size))
...
def run_simulation(args, client):
    ...
    try:
        ...
        SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=0, z=2.4)), 
                      vehicle, {'channels':'128', 'range':'100.0', 'points_per_second':'1536000', 'rotation_frequency':'10', 'horizontal_fov':'120.0', 'upper_fov':'10.0', 'lower_fov':'-15.0'}, display_pos=[0, 0])
        ...
        SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=0, z=0.0)), 
                      vehicle, {'horizontal_fov':'150.0', 'points_per_second':'1500', 'range':'100.0', 'sensor_tick':'0.05', 'vertical_fov':'30.0'}, display_pos=[0, 2])
...
def main():
    ...
    argparser.add_argument(
        ...
        default='2160x720',
        help='window resolution (default: 2160x720)')
